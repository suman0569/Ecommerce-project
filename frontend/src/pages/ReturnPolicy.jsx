  ...
  return (
    <div style={textualStyle}>
      ...
      <p style={{ marginBottom: '20px' }}>
        At Baggage, we proudly stand behind the quality of our merchandise. If for any reason you are completely disastified with your purchase, you may securely initiate a return within 30 days of receiving your order.
      </p>
      ...
      <p style={{ marginBottom: '15px' }}>
        Once your return is physically received and internally inspected, an immediate email protocol will fire notifying you of the approval status. Approved refunds will cleanly propagate to your original designated Esewa and khalti gateway endpoint within 5-7 business working days naturally.
      </p>
