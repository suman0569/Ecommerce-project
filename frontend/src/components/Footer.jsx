  ...
  return (
    <footer style={{
      ...
      <div style={{
        ...
        <div>
          <h3 style={{ color: '#f97316', marginBottom: '10px' }}>Baggage</h3>
          <p style={{ color: '#a1a1aa', fontSize: '0.9rem' }}>E-Commerce Platform.</p>
        </div>
        ...
        <div style={{ display: 'flex', gap: '20px' }}>
          ...
          <Link to="/team" style={{ color: '#a1a1aa', fontSize: '0.9rem' }} >Team</Link>
        </div>
